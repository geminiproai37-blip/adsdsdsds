  ...
  sendBugReportButton.addEventListener("click", async () => {
    ...
    try {
      ...
      if (response.ok) {
        ...
        showToast("Reporte enviado. Lo solucionaremos pronto.", "ttps://cdn.jsdelivr.net/gh//geminiproai37-blip/dsfdfd@latest/HOME/report.webp"); // Placeholder for a different success GIF
