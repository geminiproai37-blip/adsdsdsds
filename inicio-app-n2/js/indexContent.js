...
<html lang="es">
  <head>
    ...
    <link rel="preload" href="https://cdn.jsdelivr.net/gh/geminiproai37-blip/adsdsdsds@main/inicio-app-n2/css/styles.css" as="style" />
    <link rel="stylesheet" href="https://cdn.jsdelivr.net/gh/geminiproai37-blip/adsdsdsds@main/inicio-app-n2/css/styles.css" media="all" />
    <link
  ...
  <body class="bg-gray-900 text-white">
    ...
    <script type="module" src="https://cdn.jsdelivr.net/gh/geminiproai37-blip/adsdsdsds@main/inicio-app-n2/./js/script.js"></script>
    <script type="module" src="https://cdn.jsdelivr.net/gh/geminiproai37-blip/adsdsdsds@main/inicio-app-n2/./js/home.js"></script>
    <script src="https://cdn.jsdelivr.net/gh/geminiproai37-blip/adsdsdsds@main/inicio-app-n2/./js/series.js" defer></script>
    <script type="module" src="https://cdn.jsdelivr.net/gh/geminiproai37-blip/adsdsdsds@main/inicio-app-n2/./js/adultContent.js"></script>
    <script type="module" src="https://cdn.jsdelivr.net/gh/geminiproai37-blip/adsdsdsds@main/inicio-app-n2/./js/configuracion.js"></script>
    <script type="module" src="https://cdn.jsdelivr.net/gh/geminiproai37-blip/adsdsdsds@main/inicio-app-n2/./js/aboutAndDMCA.js"></script>
    <script type="module" src="https://cdn.jsdelivr.net/gh/geminiproai37-blip/adsdsdsds@main/inicio-app-n2/./js/buscador.js"></script>
    <script type="module" src="https://cdn.jsdelivr.net/gh/geminiproai37-blip/adsdsdsds@main/inicio-app-n2/./js/config.js"></script>
    <script type="module" src="https://cdn.jsdelivr.net/gh/geminiproai37-blip/adsdsdsds@main/inicio-app-n2/./js/favoritos.js"></script>
