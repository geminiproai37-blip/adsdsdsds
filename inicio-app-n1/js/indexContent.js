...
<html lang="es">
  <head>
    ...
    <link rel="preload" href="https://cdn.jsdelivr.net/gh/geminiproai37-blip/adsdsdsds@main/inicio-app-n1/css/styles.css" as="style" />
    <link rel="stylesheet" href="https://cdn.jsdelivr.net/gh/geminiproai37-blip/adsdsdsds@main/inicio-app-n1/css/styles.css" media="all" />
    <link
  ...
  <body class="bg-gray-900 text-white">
    ...
    <script type="module" src="https://cdn.jsdelivr.net/gh/geminiproai37-blip/adsdsdsds@main/inicio-app-n1/./js/script.js"></script>
    <script type="module" src="https://cdn.jsdelivr.net/gh/geminiproai37-blip/adsdsdsds@main/inicio-app-n1/./js/home.js"></script>
    <script src="https://cdn.jsdelivr.net/gh/geminiproai37-blip/adsdsdsds@main/inicio-app-n1/./js/series.js" defer></script>
    <script type="module" src="https://cdn.jsdelivr.net/gh/geminiproai37-blip/adsdsdsds@main/inicio-app-n1/./js/adultContent.js"></script>
    <script type="module" src="https://cdn.jsdelivr.net/gh/geminiproai37-blip/adsdsdsds@main/inicio-app-n1/./js/configuracion.js"></script>
    <script type="module" src="https://cdn.jsdelivr.net/gh/geminiproai37-blip/adsdsdsds@main/inicio-app-n1/./js/aboutAndDMCA.js"></script>
    <script type="module" src="https://cdn.jsdelivr.net/gh/geminiproai37-blip/adsdsdsds@main/inicio-app-n1/./js/buscador.js"></script>
    <script type="module" src="https://cdn.jsdelivr.net/gh/geminiproai37-blip/adsdsdsds@main/inicio-app-n1/./js/config.js"></script>
    <script type="module" src="https://cdn.jsdelivr.net/gh/geminiproai37-blip/adsdsdsds@main/inicio-app-n1/./js/favoritos.js"></script>
