...
<div class="flex items-center justify-center space-x-4 mx-auto max-w-3xl px-4 py-2 bg-blue-900/80 rounded-lg shadow-lg border border-orange-500/30 mb-6 mt-4">
    ...
    <button id="export-favorites-btn" class="bg-blue-600 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded-lg shadow-md transition-colors duration-200 flex items-center space-x-2">
